...
This is the development repository for rStrava, an R package to access data from the Strava API.  The package can be installed from [r-universe](https://fawda123.r-universe.dev/) and loaded as follows:

```{r eval = F}
install.packages('rStrava', repos = 'https://fawda123.r-universe.dev/')
library(rStrava)
```
